...
@WebServlet("/category_bolalar_adabiyoti")
public class Bolalar_Adabiyoti extends HttpServlet {
    CategoryService categoryService=CategoryService.getInstance();

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {

        List<Book> allCategoryBooks = categoryService.getAllCategoryBooks(CategoryName.Bolalar_Adabiyoti);
