...
@WebServlet("/category_madaniyat")
public class Madaniyat extends HttpServlet {
    CategoryService categoryService=CategoryService.getInstance();

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {

        List<Book> allCategoryBooks = categoryService.getAllCategoryBooks(CategoryName.Madaniyat);
